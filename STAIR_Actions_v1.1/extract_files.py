...
def extract_files():
    ...
    for folder in folders:
        class_folders = glob.glob(os.path.join(__location__,folder, '*'))
        ...
        for vid_class in class_folders:
            ...
            for video_path in class_files:
                ...
                if not check_already_extracted(video_parts):
                    # Now extract it.
                    src = os.path.join(__location__,train_or_test, classname, filename)
                    dest = os.path.join(__location__,train_or_test, classname,
...
def get_nb_frames_for_video(video_parts):
    ...
    generated_files = glob.glob(os.path.join(__location__, train_or_test, classname,
                                filename_no_ext + '*.jpg'))
